...
const { router: adminRoutes, adminRateLimiter } = require('./routes/admin');
const { cacheMiddleware } = require('./middleware/cacheMiddleware');
const { invalidateProduct, invalidateCategory, invalidateAll } = require('./cache/invalidation');
...
// Discount, translation, exchange rate, and backup-status routes extracted to routes/admin.js
...
// Payment routes extracted to routes/payments.js
