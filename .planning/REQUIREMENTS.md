...
- [ ] **CURR-01**: Changing the currency selector updates all displayed prices without a URL language switch
- [ ] **CURR-02**: The `currency-changed` event re-renders prices across the page (header-driven)
...
- [ ] **CURR-05**: Selected currency persists across page loads and navigation
